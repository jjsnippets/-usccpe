...
// Estose, Jude Vicris; Sarcol, Joshua; Silmaro, Jame Paul Jr.      BS CpE - 3  2026/05/20
// Assessment of Integrated Modules of TRACS (CO2)

#include <stdio.h>
#include <stdint.h>
#include <string.h>

#define PRINTDEBUG 1        // Verbose printing of internal CPU state for every instruction
#define PRINTIO 0           // Printing of IO to terminal (SevenSegment())
#define PRINTIOTEST 1       // Printing of IO to terminal (InputSim())
...
void initMemory(void) {
    ...
    ADDR=0x02D; BUS=0x1F; MainMemory();
    ...
    ADDR=0x041; BUS=0x46; MainMemory();
    ...
    ADDR=0x04D; BUS=0x54; MainMemory();
    ...
    ADDR=0x053; BUS=0x4A; MainMemory();
    ADDR=0x054; BUS=0xF8; MainMemory();
    ADDR=0x055; BUS=0x00; MainMemory();
    OE = 0; IOM = 0; RW = 0;        // Finished writing from memory
}
